...
public class MarketDataTabTest extends GcsGemsTest {
    ...
    public boolean verifyPreferedFuturesPriceField() throws StaleElementReferenceException {

        return marketDataTab.getPreferedFuturesPriceField(index).equals(preferedFuturesPriceField);
    }

    public boolean modifyPreferedFuturesPriceField() throws StaleElementReferenceException {

        marketDataTab.setPreferedFuturesPriceField(index, preferedFuturesPriceField);
        return true;
    }

    public boolean verifyPreferedOptionsPriceField() throws StaleElementReferenceException {

        return marketDataTab.getPreferedOptionsPriceField(index).equals(preferedOptionsPriceField);
    }

    public boolean modifyPreferedOptionsPriceField() throws StaleElementReferenceException {
