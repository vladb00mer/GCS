...
public class CollateralWorkbenchDeliveryTest extends GcsGemsTest {
    ...
    public boolean setCollateralWorkbenchPage() {
        ...
        collateralWorkbenchPage = new NavigationTree(getBrowser(), getResolution(), getUser())
                ...
                .deliveryCollateralWorkbenchPage();
    ...
    public boolean verifyDefaultPriorities() {
        ...
        return (collateralWorkbenchPage.getDefaultPrioritiesLabel() == defaultPriorities);
    }
    ...
    // setters section
    public void setCollateralWorkbenchPage(CollateralWorkbenchPage collateralWorkbenchPage) {
        this.collateralWorkbenchPage = collateralWorkbenchPage;
    }
